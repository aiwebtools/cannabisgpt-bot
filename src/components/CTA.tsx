  ...
  return (
    <section className="py-16 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-5xl mx-auto glassmorphism p-8 md:p-12 rounded-2xl border border-white/10 shadow-glass backdrop-blur-xl">
          <div className="grid md:grid-cols-5 gap-10 items-center">
            <div className="md:col-span-3 space-y-6">
              <h2 className="text-3xl md:text-4xl font-cyber font-bold tracking-tight">
            ...
            <div className="md:col-span-2 flex justify-center">
              <div className="relative w-full max-w-xs">
                ...
                <div className="glassmorphism rounded-2xl p-6 border border-cyber-green/30 relative z-10 flex flex-col items-center gap-4">
                  <div className="text-cyber-green text-center font-cyber text-xl">CANNABIS GPT</div>
                  <div className="w-full h-[1px] bg-gradient-to-r from-transparent via-cyber-green/30 to-transparent"></div>
                  <ul className="text-sm text-gray-300 space-y-3 w-full">
